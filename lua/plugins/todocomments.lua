...
pack.later(function()
  require("todo-comments").setup({
    ...
    keywords = {
      ...
      ERROR = { icon = " ", color = "error", alt = { "FIXME", "BUG", "FIXIT", "ISSUE" } },
...
map("n", "<leader>sT", function() require("todo-comments.fzf").todo({ keywords = { "TODO", "FIX", "FIXME" } }) end, { desc = "Todo/Fix/Fixme" })
-- stylua: ignore end
